...
export const experienceData = [
  {
    id: 1,
    title: "Desenvolvedor de Software Junior I",
    period: "2025 - o momento",
    description: "Atuação focada em back-end, desenvolvendo sistemas escaláveis, utilizando C#, .Net, AWS EC2, AWS ECS Fargate, AWS S3, AWS SQS, além de Bancos de Dados Opensearch e MongoDB na empresa BigDataCorp."
  },
  {
    id: 2,
    title: "Desenvolvedor de Software - Estágio",
    period: "2024 - 2025",
    description: "Atuação focada no desenvolvimento e manutenção de sistemas back-end utilizando o ecossistema .Net e serviços AWS na empresa BigDataCorp."
  },
  {
    id: 3,
    title: "Iniciação Científica",
    period: "2024 - 2025",
    description: "Responsável pelo treinamento e avaliação de modelos de Machine Learning em Python, visando classificar automaticamente elementos em nuvens de pontos, em apoio a projetos de engenharia civil."
  },
  {
    id: 4,
    title: "Monitor Chefe",
    period: "2022 - 2023",
    description: "Responsável por auxiliar os mais de 100 alunos, em cada semestre, no processo de aprendizado em Python."
  },
  {
    id: 5,
    title: "Piloto de Drones",
    period: "2022 - 2024",
    description: "Responsável pela produção de imagens aéreas de eventos, como casamentos, pré-casamentos e debutantes."
  }
];
